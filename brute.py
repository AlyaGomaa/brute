...
def brute(start_length=1, length=3, ramp=True, letters=True, uppercase_only=True ,lowercase_only=True , numbers=True, symbols=True, spaces=False):
    """
    ...
    :param bool uppercase_only: Include Uppercase letters only
    :param bool lowercase_only: Include Lowercase letters only
